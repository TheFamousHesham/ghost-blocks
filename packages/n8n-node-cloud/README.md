...
[![npm version](https://img.shields.io/npm/v/n8n-nodes-ghost-blocks-cloud.svg)](https://www.npmjs.com/package/n8n-nodes-ghost-blocks-cloud)
[![License](https://img.shields.io/npm/l/n8n-nodes-ghost-blocks-cloud.svg)](../../LICENSE)
...
| You are on… | Use | Why |
|---|---|---|
| **n8n Cloud** (managed) | **`n8n-nodes-ghost-blocks-cloud`** (this package) | Verified community node — installable via the in-app UI |
...
2. Enter the package name: `n8n-nodes-ghost-blocks-cloud`
3. Click **Install**
